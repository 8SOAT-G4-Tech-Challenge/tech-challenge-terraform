...
resource "aws_apigatewayv2_integration" "auth" {
  ...
  integration_uri        = "arn:aws:lambda:us-east-1:${var.aws_account_id}:function:${var.authenticate_admin_lambda_name}"
...
resource "aws_lambda_permission" "apigw_lambda" {
  ...
  function_name = var.authenticate_admin_lambda_name
